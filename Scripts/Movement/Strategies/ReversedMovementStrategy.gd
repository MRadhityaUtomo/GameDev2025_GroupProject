class_name ReversedMovementStrategy
...
func can_execute() -> bool:
	if not manager or not manager.Raycast:
		printerr("ReversedMovementStrategy: Manager atau Raycast tidak ditemukan!")
		return false
...
func exit():
	...
	if manager:
		manager.notify_movement_finished("reversed_move")
